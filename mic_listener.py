...
def listen():
    ...
    while not leave:
        ...
        recording_file_path = os.path.join(recording_dir, time.strftime("%Y%m%d-%H%M%S")+".wav")
        record_to_file(recording_file_path, raw_data, 2)
        callback_func(recording_file_path)
...
if __name__ == "__main__":
    ...
    init(_recording_dir="tmp", _callback_func=mic_listener_callback)
    listen()
