...
tf.app.flags.DEFINE_integer ('beam_width',        2048,       'beam width used in the CTC decoder when building candidate transcriptions')
tf.app.flags.DEFINE_float   ('lm_weight',         4.0,       'the alpha hyperparameter of the CTC decoder. Language Model weight.')
