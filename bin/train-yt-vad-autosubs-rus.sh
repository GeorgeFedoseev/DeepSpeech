...
python -u DeepSpeech.py \
  ...
  --n_hidden 4096 \
  --checkpoint_dir /assets/network/yt-vad-autosubs-4096/yt-vad-autosubs-4096-checkpoints/ \
  --export_dir /assets/network/yt-vad-autosubs-4096/yt-vad-autosubs-4096-export/ \
  --log_level 1 \
  --report_count 100 \
  --xla=False \
  --use_warpctc=True \
